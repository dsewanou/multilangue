...
<body>
    <div class="text-right m-3">
        <select class="form-select p-3" name="language" style="width: 10%;">
            <option value="en" {{ \Session::get('language') == 'en' ? 'selected' : '' }}>Anglais</option>
            <option value="es" {{ \Session::get('language') == 'es' ? 'selected' : '' }}>Espagnol</option>
            <option value="de" {{ \Session::get('language') == 'de' ? 'selected' : '' }}>Alleman</option>
            <option value="hi" {{ \Session::get('language') == 'hi' ? 'selected' : '' }}>Hindi</option>
            <option value="fr" {{ \Session::get('language') == 'fr' ? 'selected' : '' }}>Français</option>
        </select>
    </div>
